...
python make_csv.py --root "dataset/Libri2Mix/wav16k/min/train-100" --out  /content/train.csv
# DEV_SET
python make_csv.py --root "dataset/Libri2Mix/wav16k/min/dev" --out  /content/dev.csv
# TEST_SET
python make_csv.py --root "dataset/Libri2Mix/wav16k/min/test" --out  /content/test.csv
